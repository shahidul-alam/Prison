...
if(isset($_POST['done'])){
 ...
 $queryy = "INSERT INTO `medicalservice`(`Prisoner_ID`, `S_Date`, `Doctors_Name`, `Reason`) VALUES ('$prid','$sd','$dn','$rsn')";
...
<body>
    <div class="container">
        ...
        <div class="container">
            <div class="col-lg-12">
                <br><br>
                <h1 class="text-primary text-center"> Prisoners' who took medical service </h1>
                <br>
...
$q9 = "SELECT * FROM `medicalservice` LEFT JOIN `prisoner` ON `medicalservice`.`Prisoner_ID` = `prisoner`.`pid`";
